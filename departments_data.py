# ============================================================
# GLAT (non-dropped items only) — NEW LOGIC: 4 Departments
# Departments:
# 1) Know & Understand
# 2) Use & Apply
# 3) Evaluate & Create
...
#
# IMPORTANT:
# - Question counts differ per department (that’s intended now).
# - DROPPED items removed: 6, 9, 14, 15, 20
# ============================================================

Departments = [

    # ============================================================
    # DEPARTMENT 1 — Know & Understand (Items: 1,2,3,4,5,7,8,10)
    # ============================================================
    {
        "id": "1",
    ...
    # ============================================================
    # DEPARTMENT 2 — Use & Apply (Items: 11,12,13)
    # ============================================================
    {
        "id": "2",
    ...
    # ============================================================
    # DEPARTMENT 3 — Evaluate & Create (Items: 16,17,18,19)
    # ============================================================
    {
        "id": "3",
    ...
    # ============================================================
    # DEPARTMENT 4 — Ethics (Items: 21,22,23,24,25)
    # ============================================================
    {
        "id": "4",
